//@QnSCodeCopy
//MdStart
using QnSTradingCompany.Adapters.Exceptions;
using QnSTradingCompany.Transfer.Modules.Account;
using QnSTradingCompany.Transfer.Persistence.Account;
...
namespace QnSTradingCompany.Adapters.Service
{
