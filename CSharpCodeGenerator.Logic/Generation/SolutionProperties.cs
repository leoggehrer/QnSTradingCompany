...
namespace CSharpCodeGenerator.Logic.Generation
{
    internal partial class SolutionProperties : Contracts.ISolutionProperties
    {
        ...
        #region ProjectNames
        public IEnumerable<string> ProjectNames => CommonBase.StaticLiterals.QnSProjectExtensions.Select(e => $"{SolutionName}{e}");
        ...
        public string BlazorAppSubPath => BlazorAppProjectName;
        ...
        #region BlazorApp
        public string BlazorAppBusinessSubPath => Path.Combine(BlazorAppSubPath, StaticLiterals.ModelsFolder, StaticLiterals.BusinessFolder);
        public string BlazorAppModulesSubPath => Path.Combine(BlazorAppSubPath, StaticLiterals.ModelsFolder, StaticLiterals.ModulesFolder);
        public string BlazorAppPersistenceSubPath => Path.Combine(BlazorAppSubPath, StaticLiterals.ModelsFolder, StaticLiterals.PersistenceFolder);
        public string BlazorAppShadowSubPath => Path.Combine(BlazorAppSubPath, StaticLiterals.ModelsFolder, StaticLiterals.ShadowFolder);

        public string BlazorAppBusinessFileSubPath => Path.Combine(BlazorAppBusinessSubPath, GeneratedCodeFileName);
        public string BlazorAppModulesFileSubPath => Path.Combine(BlazorAppModulesSubPath, GeneratedCodeFileName);
        public string BlazorAppPersistenceFileSubPath => Path.Combine(BlazorAppPersistenceSubPath, GeneratedCodeFileName);
        public string BlazorAppShadowFileSubPath => Path.Combine(BlazorAppShadowSubPath, GeneratedCodeFileName);
        #endregion BlazorApp
