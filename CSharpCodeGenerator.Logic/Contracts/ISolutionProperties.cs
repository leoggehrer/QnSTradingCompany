...
namespace CSharpCodeGenerator.Logic.Contracts
{
    public interface ISolutionProperties
    {
        ...
        string BlazorAppBusinessFileSubPath { get; }
        string BlazorAppBusinessSubPath { get; }
        string BlazorAppModulesFileSubPath { get; }
        string BlazorAppModulesSubPath { get; }
        string BlazorAppSubPath { get; }
        string BlazorAppPersistenceFileSubPath { get; }
        string BlazorAppPersistenceSubPath { get; }
        string BlazorAppProjectName { get; }
        string BlazorAppShadowFileSubPath { get; }
        string BlazorAppShadowSubPath { get; }
