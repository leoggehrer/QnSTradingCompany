//@QnSGeneratedCode
namespace QnSTradingCompany.Transfer.Business.Account
{
    partial class IdentityUser : OneToAnotherModel<QnSTradingCompany.Contracts.Persistence.Account.IIdentity, QnSTradingCompany.Transfer.Persistence.Account.Identity, QnSTradingCompany.Contracts.Persistence.Account.IUser, QnSTradingCompany.Transfer.Persistence.Account.User>
    {
    }
}
namespace QnSTradingCompany.Transfer.Business.Account
...
namespace QnSTradingCompany.Transfer.Business.Account
{
    partial class AppAccess : OneToManyModel<QnSTradingCompany.Contracts.Persistence.Account.IIdentity, QnSTradingCompany.Transfer.Persistence.Account.Identity, QnSTradingCompany.Contracts.Persistence.Account.IRole, QnSTradingCompany.Transfer.Persistence.Account.Role>
    {
    }
}
namespace QnSTradingCompany.Transfer.Business.Account
